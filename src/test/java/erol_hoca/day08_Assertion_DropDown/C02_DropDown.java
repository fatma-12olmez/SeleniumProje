...
public class C02_DropDown extends TestBase {
    ...
    public void test01() {
        ...
        select.selectByIndex(5);//index 0 dan baslar Ddm 'de 6.yi alir
        //  yil.sendKeys("2018")-->Bu sekildede secebilirim
        //  driver.findElement(By.xpath("//*[value='2016']")).click();-->Bu sekildede secebilirim

        WebElement ay = driver.findElement(By.xpath("//*[@id='month']"));
        Select select1 = new Select(ay);
        // select1.selectByVisibleText("April");
        select1.selectByValue("6");//Value degeri 6 olan july secer
    ...
    public void test02() {
        ...
        List<WebElement> stateList = select.getOptions();//butun options taglarini getirir
