...
public class C03_Cookies extends TestBase {
    ...
    public void cookies() {
        ...
        //NOT:TUM COOKIES'LERI LISTELEYEBILMEK ICIN  driver.manage().getCookies(); METHODUNU KULLANIRIZ
        ...
        ****ikinci yol****
        ...
        cookieSet=driver.manage().getCookies();//Set'e ekleme oldugu icin atama yaptik
        sayac=1;
