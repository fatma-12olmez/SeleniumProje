...
public class C03_Alerts extends TestBase {
    ...
    @Test
    public void acceptAlert() throws InterruptedException {    //    Bir metod olusturun: acceptAlert
    ...
    @Test
    public void dismissalert() throws InterruptedException {//    Bir metod olusturun: dismissAlert
        driver.get("https://testcenter.techproeducation.com/index.php?page=javascript-alerts");
    ...
    @Test
    public void senKeysAlert() throws InterruptedException {//    Bir metod olusturun: sendKeysAlert
        driver.get("https://testcenter.techproeducation.com/index.php?page=javascript-alerts");
        ...
        Assert.assertTrue(result.getText().contains("Fatma"));
        System.out.println(result.getText());//-Çıkan mesajı konsola yazdırınız
